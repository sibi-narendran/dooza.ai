...
export const homeFaqData = [
    ...
    },
    {
        ...
        answer: "ChatGPT is a general assistant you have to prompt. Dooza's AI employees are specialists that work autonomously—Maily manages your inbox without you asking, Somi posts to social media daily, Rachel answers your business calls 24/7. They're employees, not tools.",
...
export const testimonials = [
    ...
    { quote: "Our social pages used to be dead. Now Ranky posts daily updates and we're actually growing our following.", author: "Suresh Timbers", role: "Retail", initials: "ST" },
