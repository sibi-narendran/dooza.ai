...
export const howItWorksSteps = [
    {
        num: '1',
        iconName: 'UserPlus',
        title: 'Hire & Assign Roles',
        desc: 'Pick your AI employees and define what they own.',
        example: 'Maily handles email. Somi runs social. Ranky owns SEO.',
        time: '2 minutes',
        outcome: 'Your AI team is ready',
    },
    {
        num: '2',
        iconName: 'Settings',
        title: 'Set Routines & Tools',
        desc: 'Give them daily tasks, connect your apps, and let them learn your voice.',
        example: 'Every morning: research trends, write a LinkedIn post, notify me on Slack.',
        time: '5 minutes',
        outcome: 'Routines locked in',
    },
    {
        num: '3',
        iconName: 'Rocket',
        title: 'They Work. You Review.',
        desc: 'Your AI team follows routines 24/7. You get notified when things are done.',
        example: '3 posts published, 12 emails handled, SEO report ready — all before 9am.',
        time: '24/7',
        outcome: 'You get your time back',
    },
];
...
export const testimonials = [
    { quote: "I'm impressed by Dooza. The flexibility and breadth of connectors are impressive, and you packaged it nicely. The UI can still be improved, but the product is strong.", author: "Golan Manor", role: "International Marketing Director · TMRG Voice Solutions", initials: "GM", logo: "/testimonials/golan.png", linkedin: "https://www.linkedin.com/in/golanmanor?utm_source=share_via&utm_content=profile&utm_medium=member_ios" },
    { quote: "Dooza.ai moves beyond traditional software tools, introducing systems that function more like operational team members.", author: "Hatrio AI", role: "AI Research", initials: "H", logo: "/testimonials/hatrio-ai.svg", website: "https://app.hatrio.ai/blog/ai-employees-changing-teams-dooza-ai", link: "https://app.hatrio.ai/blog/ai-employees-changing-teams-dooza-ai", linkedin: "https://www.linkedin.com/in/iamdinakar/", featured: true },
...
export const competitorAlternatives = [
    { name: "Sintra AI", href: "/sintra-alternatives", benefits: ["5-min setup", "70% cheaper"] },
    { name: "Marblism", href: "/marblism-alternatives", benefits: ["Free onboarding", "We build for you"] },
    { name: "Motion", href: "/blog/better-than-motion", benefits: ["All AI employees", "Better value"] }
];

// Solution cards
export const solutionCards = [
    { id: 'ai-email-automation', href: '/agents/outbound-pro', iconName: 'Send', iconBg: 'bg-gradient-to-br from-emerald-50 to-teal-100 shadow-sm shadow-emerald-100', iconColor: 'text-emerald-600', borderHover: 'hover:border-emerald-200', title: 'AI for Email Automation', desc: 'Outbound Pro helps create approved outbound campaigns, sync replies, and report campaign stats.' },
    { id: 'ai-lead-generation', href: '/agents/lead-gen-pro', iconName: 'TrendingUp', iconBg: 'bg-gradient-to-br from-orange-50 to-amber-100 shadow-sm shadow-orange-100', iconColor: 'text-orange-500', borderHover: 'hover:border-orange-200', title: 'AI for Lead Generation', desc: 'Lead Gen Pro runs focused prospect searches and saves clean CSV lead lists for your team.' },
    { id: 'ai-video-creation', href: '/agents/ugc-reel-creator', iconName: 'Video', iconBg: 'bg-gradient-to-br from-pink-50 to-rose-100 shadow-sm shadow-pink-100', iconColor: 'text-pink-500', borderHover: 'hover:border-pink-200', title: 'AI for Video Creation', desc: 'UGC Reel Creator drafts approved scripts and generates short vertical AI avatar reels.' },
    { id: 'ai-voice-agent', href: '/agents/voice-pro', iconName: 'PhoneCall', iconBg: 'bg-gradient-to-br from-blue-50 to-cyan-100 shadow-sm shadow-blue-100', iconColor: 'text-blue-500', borderHover: 'hover:border-blue-200', title: 'AI for Voice Agents', desc: 'Voice Pro captures caller context, qualification answers, booking intent, and team handoffs.' },
    ...
    { id: 'ai-visibility-growth', href: '/agents/ranky', iconName: 'Search', iconBg: 'bg-gradient-to-br from-teal-50 to-emerald-100 shadow-sm shadow-teal-100', iconColor: 'text-teal-600', borderHover: 'hover:border-teal-200', title: 'AI for Visibility & Growth', desc: 'Ranky makes you visible on Google and ChatGPT, publishes SEO blogs daily, and finds posts on LinkedIn, YouTube, and Reddit to engage with on your behalf.' }
];
