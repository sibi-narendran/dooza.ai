...
export const agentPages = [
    {
        ...
        seoTitle: 'Ranky AI Visibility Employee',
    ...
    },
    {
        ...
        seoTitle: 'Outbound Pro Email Automation',
    ...
    },
    {
        ...
        seoTitle: 'Lead Gen Pro AI Lead Generation',
    ...
    },
    {
        ...
        seoTitle: 'UGC Reel Creator for AI Videos',
    ...
    },
    {
        ...
        seoTitle: 'Voice Pro AI Voice Agent',
...
export const generateAgentSchema = (page, siteUrl = SITE_URL) => ({
    ...
    "about": [
        ...
        { "@type": "Thing", "name": page.role },
        ...page.capabilities.map(c => ({ "@type": "Thing", "name": c.title })),
    ],
    "publisher": {
        "@type": "Organization",
        "name": "Dooza",
