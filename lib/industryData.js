...
export const industryPages = [
    ...
    {
        slug: 'hvac',
        title: 'AI Answering Service for HVAC Companies: Every Emergency, Estimate & Service Call Answered 24/7',
        seoTitle: 'AI Answering Service for HVAC Companies',
        metaDescription: "A homeowner with no heat calls 3 HVAC companies and books whoever answers first. Dooza's AI agent captures every service call, books estimates, and escalates emergencies to your on-call tech — even at 2 AM.",
        keywords: ['AI answering service for HVAC', 'HVAC answering service', 'HVAC AI receptionist', 'HVAC missed calls', 'after hours HVAC answering', 'HVAC emergency call handling'],
        date: '2026-08-06',
        modifiedDate: '2026-08-06',
        faqData: [
            { question: "Can it handle emergency calls?", answer: "Yes, it detects urgent situations — no heat in winter, no cooling in a heat wave, gas smells — and escalates to your on-call tech immediately." },
            { question: "Can it book service calls and estimates?", answer: "Yes, it books into your calendar and captures the system type, issue description, and address so your tech arrives prepared." },
            { question: "Can it quote prices?", answer: "It shares your diagnostic fee and standard rates from your pricing guide. Real quotes stay with you and your techs." },
            { question: "What happens during seasonal spikes?", answer: "Unlimited simultaneous calls. Heat wave or cold snap, every caller gets answered on the first ring — no busy signal." },
            { question: "Will callers know it's AI?", answer: "It sounds natural and professional, representing your company's brand. Most callers can't tell." }
        ]
    }
];
