...
export const industryPages = [
    ...
    },
    {
        slug: 'dispatchers',
        hidePrice: true,
        title: 'AI Answering Service for Dispatchers: Every Driver, Broker & Customer Call Answered 24/7',
        seoTitle: 'AI Answering Service for Dispatchers',
        metaDescription: "You're negotiating a load while three lines ring. Dooza's AI agent answers driver check calls, broker inquiries, and after-hours emergencies, then texts you the summary.",
        keywords: ['AI answering service for dispatchers', 'truck dispatcher AI', 'freight dispatch answering service', 'AI for trucking dispatch', 'dispatch call handling', 'owner operator dispatch AI'],
        image: '/industries/dispatchers.png',
        imageAlt: 'AI answering service handling driver and broker calls for a dispatch business',
        date: '2026-08-02',
        modifiedDate: '2026-08-02',
        faqData: [
            { question: "Can it handle driver check calls?", answer: "Yes, it collects location, ETA, and status from drivers and logs or forwards the update automatically." },
            { question: "Does it work after hours?", answer: "Yes, it answers 24/7 and flags urgent calls (breakdowns, delays, emergencies) straight to your phone." },
            { question: "Can it capture new carrier or owner-operator leads?", answer: "Yes, it gathers MC number, equipment type, lanes, and availability so you can follow up fast." },
            { question: "Will callers know it's AI?", answer: "It sounds natural and professional, representing your dispatch brand. Most callers can't tell." },
            { question: "Does it work for non-trucking dispatch?", answer: "Yes, towing, field service, courier, and NEMT dispatch operations use the same workflows." }
        ]
    }
];
