...
export const automationSeoPages = {
    'ai-automation-services': {
        ...
        toolType: 'workflow-roi',
        toolTitle: 'AI Automation Services Planner',
        toolDescription:
            'Enter your real task volume and team cost. The planner estimates time saved, creates the workflow structure, and gives you a prompt to build it in Dooza Workflow.',
        toolHighlights: [
        ...
        toolInputs: [
            {
                id: 'businessType',
                label: 'Business type',
                defaultValue: 'Local service business',
                placeholder: 'Example: dental clinic, agency, ecommerce store',
                helper: 'Used in the generated workflow prompt.',
            },
            {
                id: 'currentProcess',
                label: 'Manual task',
                defaultValue: 'replying to repeated customer enquiries',
                placeholder: 'Example: triaging support emails',
                helper: 'Describe the work you want to reduce.',
            },
            {
                id: 'monthlyRuns',
                ...
                defaultValue: 120,
                suffix: '/mo',
                helper: 'How many times this task happens each month.',
            },
            {
                id: 'minutesPerRun',
                ...
                defaultValue: 12,
                suffix: 'min',
                helper: 'Current manual time per repetition.',
            },
            {
                id: 'hourlyCost',
                ...
                defaultValue: 30,
                suffix: '$',
                helper: 'Use loaded hourly cost or rough staff value.',
            },
            {
                id: 'currentApps',
                label: 'Apps involved',
                defaultValue: 'Gmail, Google Sheets, Slack',
                placeholder: 'Example: Gmail, HubSpot, Sheets',
                helper: 'These become the first connected tools.',
            },
        ],
        toolBullets: [
        ...
        automationRates: {
            'Human approval': 0.55,
            'Auto-run low-risk work': 0.72,
            'Report-only first': 0.35,
        },
        toolResults: {
            'Customer support': {
