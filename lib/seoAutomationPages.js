...
export const automationSeoPages = {
    'ai-content-automation': {
        ...
        toolHighlights: [
            ...
            { label: 'Dooza fit', value: 'Ranky, Somi, Maily, and Dooza Agent' },
        ...
        toolResults: {
            'SEO blog': {
                ...
                apps: ['Google Docs', 'WordPress', 'Google Sheets', 'Dooza Agent'],
            ...
            'LinkedIn posts': {
                ...
                apps: ['LinkedIn', 'Google Sheets', 'Google Docs', 'Dooza Agent'],
            ...
            'Email newsletter': {
                ...
                apps: ['Gmail', 'Google Docs', 'Google Sheets', 'Dooza Agent'],
            ...
            'Short-form video ideas': {
                ...
                apps: ['Google Docs', 'Google Drive', 'Instagram', 'Dooza Agent'],
        ...
        faq: [
            ...
            },
            {
                ...
                answer:
                    'It can, but many teams should start with approval before publishing. Dooza Agent can keep publishing, claims, and brand decisions behind human approval.',
            },
            {
                question: 'Which Dooza AI employees help with content automation?',
                answer:
                    'Ranky helps with SEO content, Somi helps with social content, Maily helps with email content, and Dooza Agent connects the steps.',
            },
        ],
    },
    'ai-automation-examples': {
        ...
        description:
            'Explore practical AI automation examples for support, content, SEO, lead generation, email, reporting, and operations using Dooza Agent.',
        ...
        toolDescription:
            'Enter your repeated task volume and current tools. The finder returns examples, estimated effort, a first workflow candidate, and a Dooza Agent prompt.',
        toolHighlights: [
        ...
        toolResults: {
            Support: {
                ...
                apps: ['Gmail', 'Slack', 'Google Sheets', 'Dooza Agent'],
            ...
            Sales: {
                ...
                apps: ['Google Sheets', 'Gmail', 'Apify', 'Dooza Agent'],
            ...
            Marketing: {
                ...
                apps: ['Google Docs', 'WordPress', 'LinkedIn', 'Dooza Agent'],
            ...
            Operations: {
                ...
                apps: ['Google Sheets', 'Slack', 'Google Drive', 'Dooza Agent'],
        ...
        proofPoints: [
            ...
            'Dooza employees can own the repeated work while Dooza Agent keeps approvals and execution visible.',
        ],
        ...
        faq: [
            ...
            {
                question: 'Can these examples run in Dooza Agent?',
                answer:
                    'Yes. Dooza Agent is built to connect triggers, AI steps, business tools, approval branches, and reports into one workflow.',
            },
        ],
    },
    'ai-blog-automation': {
        ...
        toolHighlights: [
            ...
            { label: 'Dooza fit', value: 'Ranky plus Dooza Agent' },
        ...
        toolResults: {
            ...
            'Product education': {
                ...
                output: 'A product education post that links to Dooza and Dooza Agent.',
                apps: ['Google Docs', 'Dooza Agent', 'WordPress', 'Google Drive'],
            ...
            'Comparison pages': {
                ...
                apps: ['Google Docs', 'Google Sheets', 'WordPress', 'Dooza Agent'],
        ...
        proofPoints: [
            ...
            'Dooza Agent makes SEO publishing repeatable with the same steps every week instead of scattered documents.',
        ],
        ctaTitle: 'Turn SEO publishing into a weekly workflow',
        ctaText:
            'Book a demo and see how Ranky and Dooza Agent can produce SEO content without a messy manual process.',
        faq: [
            {
            ...
            },
            {
                ...
                answer:
                    'Most businesses should start with human review. Dooza Agent can draft and prepare posts while keeping publishing behind approval.',
            },
            {
    ...
    'start-ai-automation-agency': {
        ...
        description:
            'Learn how to start an AI automation agency by packaging repeatable workflows, choosing offers, delivering with Dooza Agent, and selling clear outcomes.',
        eyebrow: 'Start an AI automation agency',
        heroTitle: 'Build a sellable AI automation agency offer around one workflow',
        heroText:
            'Use this free offer builder to pick a niche, package a workflow, define deliverables, and create a demo angle you can sell with Dooza Agent.',
        ...
        toolResults: {
            'Local services': {
                ...
                apps: ['Gmail', 'Google Calendar', 'Google Sheets', 'Dooza Agent'],
            ...
            Clinics: {
                ...
                apps: ['Gmail', 'Google Sheets', 'Google Calendar', 'Dooza Agent'],
                employee: 'Maily plus Dooza Agent approvals',
            ...
            Agencies: {
                ...
                apps: ['Google Docs', 'Google Sheets', 'Slack', 'Dooza Agent'],
            ...
            Ecommerce: {
                ...
                apps: ['Gmail', 'Shopify', 'Google Sheets', 'Dooza Agent'],
        ...
        steps: [
            ...
            'Build delivery using Dooza AI employees and Dooza Agent templates.',
        ...
        proofPoints: [
            ...
            'Dooza Agent gives agencies a visual demo they can show clients before implementation starts.',
        ...
        faq: [
            {
                ...
                answer:
                    'Start by choosing one niche, finding one repeated workflow, building a clear service package, and using a platform like Dooza Agent to deliver the automation reliably.',
            },
            {
            ...
            },
            {
                ...
                answer:
                    'Yes. Agencies can use Dooza AI employees and Dooza Agent to create visual workflows, connect tools, add approvals, and run repeatable client systems.',
            },
        ],
    },
};
