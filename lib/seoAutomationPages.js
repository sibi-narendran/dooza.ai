...
export const automationSeoPages = {
    'ai-content-automation': {
        ...
        toolHighlights: [
            ...
            { label: 'Dooza fit', value: 'Ranky, Somi, Maily, and Dooza Agents' },
        ...
        toolResults: {
            'SEO blog': {
                ...
                apps: ['Google Docs', 'WordPress', 'Google Sheets', 'Dooza Agents'],
            ...
            'LinkedIn posts': {
                ...
                apps: ['LinkedIn', 'Google Sheets', 'Google Docs', 'Dooza Agents'],
            ...
            'Email newsletter': {
                ...
                apps: ['Gmail', 'Google Docs', 'Google Sheets', 'Dooza Agents'],
            ...
            'Short-form video ideas': {
                ...
                apps: ['Google Docs', 'Google Drive', 'Instagram', 'Dooza Agents'],
        ...
        faq: [
            ...
            },
            {
                ...
                answer:
                    'It can, but many teams should start with approval before publishing. Dooza Agents can keep publishing, claims, and brand decisions behind human approval.',
            },
            {
                question: 'Which Dooza AI employees help with content automation?',
                answer:
                    'Ranky helps with SEO content, Somi helps with social content, Maily helps with email content, and Dooza Agents connects the steps.',
            },
        ],
    },
    'ai-automation-examples': {
        ...
        description:
            'Explore practical AI automation examples for support, content, SEO, lead generation, email, reporting, and operations using Dooza Agents.',
        ...
        toolDescription:
            'Enter your repeated task volume and current tools. The finder returns examples, estimated effort, a first workflow candidate, and a Dooza Agents prompt.',
        toolHighlights: [
            ...
            { label: 'Dooza fit', value: 'Examples map into visible Dooza Agents' },
        ...
        toolResults: {
            Support: {
                ...
                apps: ['Gmail', 'Slack', 'Google Sheets', 'Dooza Agents'],
            ...
            Sales: {
                ...
                apps: ['Google Sheets', 'Gmail', 'Apify', 'Dooza Agents'],
            ...
            Marketing: {
                ...
                apps: ['Google Docs', 'WordPress', 'LinkedIn', 'Dooza Agents'],
            ...
            Operations: {
                ...
                apps: ['Google Sheets', 'Slack', 'Google Drive', 'Dooza Agents'],
        ...
        proofPoints: [
            ...
            'Dooza employees can own the repeated work while Dooza Agents keeps approvals and execution visible.',
        ],
        ...
        faq: [
            ...
            {
                question: 'Can these examples run in Dooza Agents?',
                answer:
                    'Yes. Dooza Agents is built to connect triggers, AI steps, business tools, approval branches, and reports into one workflow.',
            },
        ],
    },
    'ai-blog-automation': {
        ...
        toolHighlights: [
            ...
            { label: 'Dooza fit', value: 'Ranky plus Dooza Agents' },
        ...
        toolResults: {
            ...
            'Product education': {
                ...
                output: 'A product education post that links to Dooza and Dooza Agents.',
                apps: ['Google Docs', 'Dooza Agents', 'WordPress', 'Google Drive'],
            ...
            'Comparison pages': {
                ...
                apps: ['Google Docs', 'Google Sheets', 'WordPress', 'Dooza Agents'],
            ...
            'Industry pages': {
                ...
                summary:
                    'Create repeatable industry pages that map pain points to Dooza Agents, examples, trust signals, and CTAs.',
        ...
        proofPoints: [
            ...
            'Dooza Agents makes SEO publishing repeatable with the same steps every week instead of scattered documents.',
        ],
        ctaTitle: 'Turn SEO publishing into a weekly workflow',
        ctaText:
            'Book a demo and see how Ranky and Dooza Agents can produce SEO content without a messy manual process.',
        faq: [
            {
            ...
            },
            {
                ...
                answer:
                    'Most businesses should start with human review. Dooza Agents can draft and prepare posts while keeping publishing behind approval.',
            },
            {
    ...
    'start-ai-automation-agency': {
        ...
        description:
            'Learn how to start an AI automation agency by packaging repeatable workflows, choosing offers, delivering with Dooza Agents, and selling clear outcomes.',
        eyebrow: 'Start an AI automation agency',
        heroTitle: 'Build a sellable AI automation agency offer around one workflow',
        heroText:
            'Use this free offer builder to pick a niche, package a workflow, define deliverables, and create a demo angle you can sell with Dooza Agents.',
        ...
        toolResults: {
            'Local services': {
                ...
                apps: ['Gmail', 'Google Calendar', 'Google Sheets', 'Dooza Agents'],
            ...
            Clinics: {
                ...
                apps: ['Gmail', 'Google Sheets', 'Google Calendar', 'Dooza Agents'],
                employee: 'Maily plus Dooza Agents approvals',
            ...
            Agencies: {
                ...
                apps: ['Google Docs', 'Google Sheets', 'Slack', 'Dooza Agents'],
            ...
            Ecommerce: {
                ...
                apps: ['Gmail', 'Shopify', 'Google Sheets', 'Dooza Agents'],
        ...
        steps: [
            ...
            'Build delivery using Dooza AI employees and Dooza Agents templates.',
        ...
        proofPoints: [
            ...
            'Dooza Agents gives agencies a visual demo they can show clients before implementation starts.',
        ...
        faq: [
            {
                ...
                answer:
                    'Start by choosing one niche, finding one repeated workflow, building a clear service package, and using a platform like Dooza Agents to deliver the automation reliably.',
            },
            {
            ...
            },
            {
                ...
                answer:
                    'Yes. Agencies can use Dooza AI employees and Dooza Agents to create visual workflows, connect tools, add approvals, and run repeatable client systems.',
            },
        ],
    },
};
