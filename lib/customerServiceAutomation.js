...
const sharedFaq = [
    ...
    },
    {
        ...
        answer:
            'A chatbot usually answers inside one conversation. Dooza combines AI employees with Dooza Agent, so support work can trigger from email, chat, or forms, route through approval steps, update tools, and leave a visible run history.',
    },
    {
...
export const customerServiceToolPages = {
    'best-customer-service-automation-software': {
        ...
        description:
            'Use this customer service automation calculator to estimate support workload, request a savings report, and see how Dooza combines AI employees with Dooza Agent.',
        ...
        pitchText:
            'Dooza pitches a complete operating system: an AI employee for support work, and Dooza Agent to connect tools, add approvals, route exceptions, and log every run.',
        ...
        comparisonRows: [
            ...
            ['Dooza + Dooza Agent', 'AI drafts and classifies while workflows handle approvals, tool updates, routing, reporting, and audit history.'],
        ],
        faqs: sharedFaq,
    },
    'customer-service-automation-solutions': {
        ...
        comparisonRows: [
            ...
            ['Connected actions', 'Where Dooza Agent should update tools, save records, notify the team, and report results.'],
        ],
        faqs: sharedFaq,
    },
};
...
export function calculateCustomerServiceReport(slug, input = {}) {
    ...
    const doozaPitch =
        'Use Maily or a support-focused Dooza AI employee for classification, summarization, and reply drafting. Use Dooza Agent for the visible operating layer: triggers, branches, approvals, connected tool updates, alerts, and run history.';

    const prompt = [
        `Build a Dooza Agent for ${businessType} customer service automation.`,
        '',
