...
export const metadata = {
    title: {
        absolute: 'Automate Customer Support with Dooza Workflow | AI Support Done For You',
    },
    description:
        'Build an AI-powered customer support workflow that replies to customers in seconds. Dooza Workflow + AI employees handle email, chat, and tickets 24/7. $199/mo, done for you.',
    keywords: [
    ...
    openGraph: {
        title: 'Automate Customer Support with Dooza Workflow | AI Support Done For You',
        description: 'Build a support workflow that replies in seconds. Dooza Workflow + AI employees. Done-for-you at $199/mo.',
        url: pageUrl,
        siteName: 'Dooza',
        type: 'website',
        images: [{ url: `${SITE_URL}/logo.png`, width: 512, height: 512, alt: 'Dooza Workflow - Customer Support Automation' }],
    },
    twitter: {
        card: 'summary_large_image',
        title: 'Automate Customer Support with Dooza Workflow | Dooza',
        description: 'AI-powered support workflow that replies in seconds. Dooza Workflow + AI employees. $199/mo done-for-you.',
...
const faqData = [
    {
        ...
        answer: 'Dooza Workflow is an automation platform that connects your business tools and runs AI-powered processes. For customer support, it detects new emails or messages, sends them to a Dooza AI employee for understanding and drafting, and delivers instant replies to your customers.',
    },
    {
        question: 'How is this different from a chatbot?',
        answer: 'Chatbots follow rigid scripts and break when questions go off-script. Dooza Workflow runs a full AI employee that reads, understands context, checks your knowledge base, and writes natural replies. It handles the entire workflow — not just a chat widget.',
    },
    {
...
const schemas = [
    {
        ...
        '@type': 'WebPage',
        name: 'Automate Customer Support with Dooza Workflow',
        url: pageUrl,
    ...
    },
    {
        ...
        name: 'Dooza Workflow - Customer Support',
        ...
        <BookingModalProvider>
            ...
            <main id="main-content" className="bg-warm text-slate-900">
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto text-center">
                        <ScrollReveal>
                            <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-primary-100 bg-white/80 px-4 py-2 text-sm font-bold text-primary-700 shadow-sm backdrop-blur">
                                ...
                                Dooza Workflow &mdash; Customer Support
                            </div>
                            ...
                            <p className="mb-9 max-w-2xl mx-auto text-lg leading-relaxed text-slate-600 md:text-xl">
                                Use Dooza Workflow to create an automated support system. An AI employee reads every customer email, understands the problem, and replies instantly &mdash; you only step in when it actually needs you.
                            </p>
                ...
                <section className="bg-warm px-4 py-20 md:py-28">
                    <div className="max-w-4xl mx-auto">
                        <ScrollReveal>
                            ...
                            <p className="text-lg text-slate-600 text-center mb-16 max-w-xl mx-auto">Dooza Workflow connects to your email, runs an AI employee on every ticket, and handles the rest.</p>
                        </ScrollReveal>
                        <div className="space-y-8">
                            <div className="flex gap-6 items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600 leading-relaxed">Dooza Workflow detects a new support email the moment it hits your inbox. Works with Gmail, Outlook, or any email provider.</p>
                                </div>
                            </div>
                ...
                <section className="bg-white px-4 py-20 md:py-28">
                    <div className="max-w-5xl mx-auto">
                        <ScrollReveal>
                            <h2 className="font-serif text-3xl font-bold text-slate-950 md:text-5xl text-center mb-14">Before vs After Dooza Workflow</h2>
                        </ScrollReveal>
                            ...
                            <div className="grid gap-8 md:grid-cols-[1fr_auto] items-center">
                                <div>
                                    ...
                                    <h2 className="font-serif text-2xl font-bold text-slate-950 md:text-4xl mb-4">
                                        Dooza Workflow + Dooza AI Employees
                                    </h2>
                                    <p className="text-slate-600 leading-relaxed mb-4">
                                        Dooza Workflow is the automation engine &mdash; it connects your tools, triggers actions, and runs your support process. Dooza AI employees are the brains &mdash; they read, understand, decide, and reply like a trained support agent.
                                    </p>
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto text-center">
                        <ScrollReveal>
                            ...
                            <p className="mx-auto mb-10 max-w-xl text-lg leading-relaxed text-slate-600">
                                Dooza Workflow + AI employees = customer support on autopilot. Try it free, cancel within 7 days if it&apos;s not for you.
                            </p>
                            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                                <a
                                    href={WORKFLOW_SIGNUP_URL}
