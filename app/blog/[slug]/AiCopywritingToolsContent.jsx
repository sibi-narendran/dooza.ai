                        ...
                        <section id="tools-comparison" className="scroll-mt-28">
                            ...
                            <div className="bg-amber-50 border border-amber-200 p-6 rounded-xl">
                                ...
                                <p className="text-amber-700">
                                    Most AI copywriting tools just generate text—you still have to copy/paste, format, and publish manually. Dooza's AI employees (Somi for social media, Ranky for SEO/blogs) create AND publish content automatically. You approve what goes live, but the heavy lifting is done for you.
                                </p>
                            </div>
                        </section>
                                ...
                                <div className="flex flex-col md:flex-row items-center gap-8">
                                    ...
                                    <div>
                                        ...
                                        <ul className="space-y-2 text-slate-700">
                                            ...
                                            <li className="flex items-center gap-2">
                                                <CheckCircle2 className="w-5 h-5 text-green-500" />
                                                <span><strong>Ranky</strong> writes and publishes SEO-optimized blog posts</span>
                                            </li>
                                            <li className="flex items-center gap-2">
                                                <CheckCircle2 className="w-5 h-5 text-green-500" />
                                                <span><strong>Maily</strong> drafts and sends personalized emails</span>
                                            </li>
                                            <li className="flex items-center gap-2">
                                                <CheckCircle2 className="w-5 h-5 text-green-500" />
