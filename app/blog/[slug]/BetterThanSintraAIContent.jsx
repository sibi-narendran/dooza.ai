...
const faqData = [
    ...
    },
    {
        ...
        answer: "You can still sign up for Dooza ($49/mo with a 7-day money-back guarantee) and test it alongside Sintra."
    },
    {
                    ...
                    <div className="w-full max-w-3xl mx-auto space-y-12">
                        ...
                        <section id="conclusion" className="scroll-mt-28">
                            ...
                            <div className="bg-primary-50 border border-primary-100 p-8 rounded-xl text-center">
                                ...
                                <p className="text-slate-600 mb-6 max-w-xl mx-auto">Get started with Dooza from $49/mo. 7-day money-back guarantee.</p>
