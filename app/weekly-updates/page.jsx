import WeeklyUpdatesPageClient from './WeeklyUpdatesPageClient';
...
export const metadata = {
    title: { absolute: 'Weekly Catch Up | Dooza' },
    description: 'Book your weekly catch up with the Dooza team to review progress, clear blockers, and set priorities for the week ahead.',
    alternates: {
        canonical: 'https://www.dooza.ai/weekly-updates',
    },
    robots: {
        index: false,
        follow: true,
    ...
    openGraph: {
        title: 'Weekly Catch Up | Dooza',
        description: 'Pick a time for your weekly catch up — review progress, clear blockers, and plan the week ahead.',
        url: 'https://www.dooza.ai/weekly-updates',
