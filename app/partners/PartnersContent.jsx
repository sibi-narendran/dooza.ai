...
export default function PartnersContent() {
    ...
    const [avgDealValue, setAvgDealValue] = useState(850);
                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                                    Revenue that <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-primary-400">Compounds</span>
                                </h2>
                        ...
                        <div className="grid md:grid-cols-3 gap-12">
                            {[
                                ...
                                },
                                {
                                    step: "02",
                                    title: "Share Link",
                                    desc: "Promote Dooza to your audience using your unique link."
                                },
                                {
                                    step: "03",
                                    title: "Get Paid",
