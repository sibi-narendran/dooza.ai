...
const comparisonRows = [
    ...
    {
        label: 'Dooza',
        desc: 'Combines AI employees, Dooza Workflow, integrations, approvals, and reporting into one support automation system.',
    },
];
...
const schemas = [
    ...
    },
    {
        ...
        description:
            'Done-for-you customer support automation using Dooza AI employees and Dooza Workflow for triage, replies, routing, approvals, and tool updates.',
        hasOfferCatalog: {
            '@type': 'OfferCatalog',
        ...
        <BookingModalProvider>
            ...
            <main id="main-content" className="bg-warm text-slate-900">
                ...
                <section className="px-4 py-20 md:px-8 md:py-28">
                    <div className="mx-auto max-w-7xl">
                        <SectionHeader
                            eyebrow="Dooza + Dooza Workflow"
                            title="AI replies are only one part of the system"
                            description="Dooza handles the support thinking. Dooza Workflow handles the routing, approvals, records, tool actions, and evidence trail."
                        />
                        <div className="grid gap-6 lg:grid-cols-2">
                            ...
                            <div className="card-interactive group rounded-[28px] border border-slate-100 bg-white p-6 shadow-sm transition-all hover:border-primary-100 hover:shadow-lg md:p-8">
                                ...
                                <h3 className="font-sans text-2xl font-extrabold text-slate-950">Dooza Workflow</h3>
                                <p className="mt-4 text-base leading-relaxed text-slate-600">
