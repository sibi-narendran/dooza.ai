...
const RelatedPosts = ({ currentSlug, category, tags = [], maxPosts = 2, allPosts }) => {
    ...
    return (
        <section className="scroll-mt-28 py-12 md:py-16 bg-slate-50 border-t border-slate-100">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">Related Articles</h2>
