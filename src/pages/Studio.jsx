                            ...
                            {TESTIMONIALS.map((testimonial) => (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-full bg-linear-to-br from-primary-400 to-primary-600 flex items-center justify-center font-semibold text-sm text-white">
                                            {testimonial.avatar}
                                        </div>
                                        <div>
